...
_.identity = function (val) {
  // TODO: 여기에 코드를 작성합니다.
  /*identity
      ✓ Array, Set, Map 내장 메소드를 사용하지 않고, 언더바의 메스드를 구현할 수 있어야 합니다
      1) 전달받은 입력값을 그대로 리턴해야 합니다*/
  return val
};
...
_.take = function (arr, n) {
  ...
  /* take
      ✓ Array, Set, Map 내장 메소드를 사용하지 않고, 언더바의 메스드를 구현할 수 있어야 합니다
      1) 두 번째 입력이 생략된 경우, 빈 배열을 리턴해야 합니다
      2) 차례대로 처음 n개의 요소를 갖는 배열을 리턴해야 합니다
      3) 두 번째 입력이 0인 경우, 빈 배열을 리턴해야 합니다
      4) 두 번째 입력이 배열의 길이를 벗어날 경우, 배열 전체를 리턴해야 합니다
      */
    if(n === undefined || n <= 0){
      return []
    }
    ...
    //위의 구현된 슬라이스를 사용해서 0번째부터 n번째까지 자른다.
};
...
_.drop = function (arr, n) {
  ...
  drop
      ✓ Array, Set, Map 내장 메소드를 사용하지 않고, 언더바의 메스드를 구현할 수 있어야 합니다
      1) 두 번째 입력이 생략된 경우, 전체 배열을 리턴해야 합니다
      2) 차례대로 처음 n개의 요소가 제외된 배열을 리턴해야 합니다
      3) 두 번째 입력이 0인 경우, 전체 배열을 리턴해야 합니다
      4) 두 번째 입력이 배열의 길이를 벗어날 경우, 빈 배열을 리턴해야 합니다
  */
 if(n < 0 || n === undefined){
   return arr;
 }
...
_.last = function (arr, n) {
  ...
  /*last
      ✓ Array, Set, Map 내장 메소드를 사용하지 않고, 언더바의 메스드를 구현할 수 있어야 합니다
      1) 두 번째 입력이 생략된 경우, 마지막 요소만을 담은 배열을 리턴해야 합니다
      2) 차례대로 마지막 n개의 요소를 갖는 배열을 리턴해야 합니다
      3) 두 번째 입력이 0인 경우, 빈 배열을 리턴해야 합니다
      4) 두 번째 입력이 배열의 길이를 벗어날 경우, 배열 전체 리턴해야 합니다*/
  if(n < 0 || n === undefined){
 ...
 *  배열 arr을 입력받을 경우, iteratee(ele, idx, arr) arr[idx] = ele
 *  객체 obj를 입력받을 경우, iteratee(val, key, obj) obj[key] = val
